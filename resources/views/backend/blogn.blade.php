                        ...
                        <ul class="sidebar__post-list list-unstyled">
                            ...
                            <li>
                                ...
                                <div class="sidebar__post-content">
                                    <h3>
                                        <a href="{{route('blogdetailsn', $blog->id)}}">{{$blog->title}}</a>
                                    </h3>
                ...
                <div class="blog-page__right">
                    ...
                    <div class="blog-page__single">
                        ...
                        <div class="blog-page__content">
                            ...
                            <h3 class="blog-page__title"><a href="{{route('blogdetailsn', $blog->id)}}">{{$blog->title}}</a></h3>
                            <p class="blog-page__text-1">{{$blog->details}}</p>
                            <div class="blog-page__btn-box">
                                <a href="{{route('blogdetailsn', $blog->id)}}" class="blog-page__btn">Read More</a>
                            </div>
                        </div>
                    </div>
                    @endforeach

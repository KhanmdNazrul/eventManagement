    ...
    <div class="container-fluid">
        <div class="page-title-box">
            ...
            <div class="row align-items-center ">
                <div class="col-md-8">
                    <div class="page-title-box">
                        <h4 class="page-title">Audience Table</h4>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a href="javascript:void(0);">Attendee</a>
                            </li>
                            <li class="breadcrumb-item">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mt-0 header-title">Audience Lists</h4>
                        <p class="sub-title">Here are the Audience of our Events.</p>

                        <div class="table-rep-plugin">
                            <div class="table-responsive b-0" data-pattern="priority-columns">
                            <div class="float-right"><a href="{{route('attendee.create')}}"><button class="btn btn-success">Add New</button></a></div>

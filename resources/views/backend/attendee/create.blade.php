...
<div class="container-fluid">
    <div class="page-title-box">
        ...
        <div class="row align-items-center ">
            <div class="col-md-8">
                <div class="page-title-box">
                    <h4 class="page-title">New Attendee registration Form</h4>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Attendee Registration Form</li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="col-lg-8 offset-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">Attendee Registration Form</h4>
                                    ...
                                    <form action="{{route('attendee.store')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>Address</label>
                                            <div>
                                                <textarea name="address" required class="form-control" rows="5" placeholder="Eneter your Current Address">{{old('address')}}</textarea>
                                            </div>
                                            @error('address')
												<div class="alert alert-danger">{{$message}}</div>
												@enderror
                                        ...
                                        <div class="form-group">
                                            <label>Image</label>
                                            <div>
                                            <input name="photo" type="file" value="{{old('photo')}}" class="form-control"  placeholder="upload your image" />
                                            </div>
                                            @error('photo')
												<div class="alert alert-danger">{{$message}}</div>
												@enderror

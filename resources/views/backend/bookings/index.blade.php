            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mt-0 header-title">Booking List</h4>
                        <p class="sub-title">Here are the all Bookings of our events. </p>
                            ...
                            <div class="float-right"><a href="{{route('testimonial.create')}}"><button class="btn btn-success">Add New</button></a></div>
                                ...
                                <table id="tech-companies-1" class="table  table-striped">
                                    <thead>
                                        <tr>
                                            <th>SN</th>
                                            <th data-priority="1">Attendee</th>
                                            <th data-priority="1">Event</th>
                                            <th data-priority="1">Tickets</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$booking->attendee->name}}</td>
                                            <td>{{$booking->event->title}}</td>
                                            <td>{{$booking->num_tickets}}</td>
                                            <td>{{$booking->total_price}}</td>
                                            <td><a href="{{route('changeStatus', $booking->id)}}" class="{{$booking->status == 'confirmed' ?  'btn btn-sm btn-success': 'btn btn-sm btn-warning'}}">{{$booking->status}}</a></td>
                                            <td>

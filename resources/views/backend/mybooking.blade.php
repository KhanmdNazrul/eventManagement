            ...
            <div class="col-xl-12">
                <div class="contact-two__right">
                    <div class="section-title text-left"><br><br>
                        ...
                        <h2 class="section-title__title">Here are my all events <span>Bookings</span></h2>
                    </div>
                            ...
                            <div class="table-responsive b-0" data-pattern="priority-columns">
                                ...
                                @foreach($mbook as $book)
                                        <tr>
                                            ...
                                            <td>{{$book->event->title}}</td>
                                            <td>{{$book->event->address}}</td>
                                            <td>{{$book->event->start_date}}</td>
                                            <td>{{$book->num_tickets}}</td>
                                            <td>{{$book->total_price}}</td>
                                            <td style="background-color:blue; color:white">{{$book->status}}</td>
                                        </tr>
                                      @endforeach
                                    </tbody>
                                </table>

...
<section class="speaker-single">
    <div class="container">
        <div class="row">
            ...
            <h2>Available Tickets: <span style="color: blue;">{{$total}}</span> </h2><br>

            <div class="events-three__btn-box">
                                        <a href="{{route('bookingn',$event->id)}}" class="about-three__btn thm-btn-two"><span
        ...
        <div class="speaker-single__bottom">
            <div class="speaker-bottom__img-and-content">
                <div class="speaker-bottom__img">
                    <img src="images/team/speaker-single-bottom-img.jpg" alt="">

    ...
    <div class="container-fluid">
        <div class="page-title-box">
            ...
            <div class="row align-items-center ">
                <div class="col-md-8">
                    <div class="page-title-box">
                        <h4 class="page-title">Speaker</h4>
                        <ol class="breadcrumb">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                       ...
                       <img src="{{asset($speaker->photo)}}" width="300px" height="300px" alt="">
                       <br>
                       <h2>Name: {{$speaker->name}} </h2>
                       <h3>Specialized in {{$speaker->profession}}</h3>
                       <h4>Details: {{$speaker->details}}</h4>

            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="sub-title">Here are the Blog of our events. </p>

                        <div class="table-rep-plugin">
                            <div class="table-responsive b-0" data-pattern="priority-columns">
                            <div class="float-right"><a href="{{route('blog.create')}}"><button class="btn btn-success">Add New</button></a></div>

                                <table id="tech-companies-1" class="table  table-striped">
                                    <thead>
                                        <tr>
                                            <th>SN</th>
                                            <th data-priority="1">Post by</th>
                                            <th data-priority="3">Title</th>
                                            <th data-priority="1">Poto</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$blog->title}}</td>
                                            <td><img src="{{asset($blog->photo)}}" width="100px" alt=""></td>

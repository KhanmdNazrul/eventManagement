            ...
            <div class="col-xl-7">
                <div class="contact-two__right">
                    ...
                    <div class="contact-two__form-box">
                        ...
                        <form class="contact-two__form" method="post" action="{{route('contact.storen')}}">
                            @csrf
                            <div class="row">
                                <div class="col-xl-6 col-lg-6">
                                    <div class="contact-two__input-box">
                                        <input type="hidden" name="name" value="{{Auth()->guard()->user()->name}}" placeholder="Your name" required="">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6">
                                    <div class="contact-two__input-box">
                                        <input type="hidden" name="email" value="{{Auth()->guard()->user()->email}}" placeholder="Email Address"
                                            required="">
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6 col-lg-6">
                                    <div class="contact-two__input-box">
                                        <input type="hidden" value="{{Auth()->guard()->user()->phone}}" name="phone" placeholder="Enter Phone"
                                            required="">
                                    </div>
                                </div>
